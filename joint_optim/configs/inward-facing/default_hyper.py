...
fine_train = dict(
    ...
    lrate_feature=1e-2,           # lr of voxel grid
    lrate_featurenet=1e-3,
    lrate_decoder=1e-3,
     lrate_temperature = 1e-2,
     lrate_dino_decoder = 1e-4,
    lrate_slots = 1e-2,
    lrate_density = 1e-2,
    ...
    tv_feature_before=0,            # count total variation densely before the given number of iterations
