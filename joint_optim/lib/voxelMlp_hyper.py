...
class VoxelMlp(torch.nn.Module):
    def __init__(self, xyz_min, xyz_max,
        ...
        # self.temperature = torch.nn.Parameter(0.2 * torch.ones([1, 1], dtype = torch.float32))


        # #self.dino_decoder = nn.Linear(self.dino_channel, featurenet_width)
    ...
    def sample_ray(self, rays_o, rays_d, near, far, stepsize, is_train=False, **render_kwargs):
        ...
        # import pdb
        # if t.shape[0]!= mask_inbbox.shape[0]:
        #     pdb.set_trace()
        ...
        #print(ray_pts.shape, t_min.shape, t_max.shape)
